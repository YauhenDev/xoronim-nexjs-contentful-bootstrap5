export const state = {
	...
	indexDetails: {
		h2		: "Детали",
		p		: "Смерть близкого человека может наступить внезапно. Родственникам, несмотря на огромное горе, приходится заниматься похоронами. Чтобы правильно организовать погребение, следует учитывать множество нюансов, а также необходимо выполнить ряд формальностей, являющихся обязательными в случае смерти человека."
	},
	indexServices: {
	...
	indexQuestions: {
		h2		: "Остались вопросы?",
		p		: "Если у вас произошла трагедия и вы не знаете как организовать похороны и куда обращаться позвоните нам или вызовите ритуального агента и мы всё сделаем за вас."
	},
	indexShowroom: {
		h2		: "Выставочный зал",
